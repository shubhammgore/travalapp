		...
		<ExploreSectionContainer name='Explore'>
			...
			<ExploreSectionWrapper>
				<Carousel dynamicHeight={false}>
					<Item>
						<img src={BaliTempleImg} alt='bali img' />
						<Description>Bali Temple</Description>
					</Item>
					<Item>
						<img src={RiceTerraceImg} alt='Rice terr img' />
						<Description>Rice Terrace</Description>
					</Item>
					<Item>
						<img src={ExoticBromoImg} alt='exotic brome img' />
						<Description>Exotic Bromo</Description>
					</Item>
					<Item>
						<img src={MaleMaldivesImg} alt='male img' />
						<Description>Male Maldives</Description>
					</Item>
					<Item>
						<img src={IceTeaImg} alt='icetea img' />
